$(document).ready(function() {
    ...
    function openModal(data = null) {
        if (data) {
            $('#modalTitle').text('Editar Falta de personal');
            $('#id').val(data.id);
            ...
            $('#modalTitle').text('Agregar Falta de personal');
            itemForm.reset();
            $('#id').val('');
        }
    ...
    $('#exportarPersonalizado').on('click', function() {
        ...
        var nombreArchivo = `Reporte_Faltapersonal_${edificioSeleccionado || 'Todos'}_${fecha}.xlsx`;
